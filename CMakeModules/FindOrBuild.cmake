...
macro(FindOrBuildSDL2)
    if(operating_system_android)
        set(ENV{SDL2DIR} "$ENV{ANDROID_SDL2_ROOT};$ENV{ANDROID_SDL2_ROOT}/libs/armeabi/")
        find_package(SDL2)
    else()
...
macro(FindOrBuildJPEG)
	...
	elseif(operating_system_android)
        message("Will build jpeg for android")
        Add_Subdirectory_Once(${CMAKE_SOURCE_DIR}/thirdparty/libjpeg ${CMAKE_BINARY_DIR}/thirdparty/libjpeg)
        find_path(JPEG_INCLUDE_DIR NAMES jpeglib.h HINTS ${CMAKE_SOURCE_DIR}/thirdparty/libjpeg)
...
macro(FindOrBuildPNG)
    ...
    elseif(operating_system_android)
        message("Will build png for android")
        Add_Subdirectory_Once(${CMAKE_SOURCE_DIR}/thirdparty/libpng ${CMAKE_BINARY_DIR}/thirdparty/libpng)
